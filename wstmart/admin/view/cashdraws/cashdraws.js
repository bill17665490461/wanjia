...
function initGrid(){
	grid = $("#maingrid").ligerGrid({
        ...
        columns: [
            ...
            { display: '提现对象', name: 'targetType',Sort: false,render: function (rowdata, rowindex, value){
	            if(rowdata['targetType']==1){return '会员'}else if(rowdata['targetType']==2){return '店铺'}else if(rowdata['targetType']==3){return '区域商'};
	        }},
