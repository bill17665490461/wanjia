...
use wstmart\admin\model\Agencysettlements as M;
/**
 * ============================================================================
 *  MKT多用户商城
...
class Agencysettlements extends Base{
     ...
     * 进入平台结算野蛮
     */
    public function toAgencyIndex(){
        $this->assign("areaList",model('areas')->listQuery(0));
        return $this->fetch('list_agency');
    }
    ...
    public function generateSettleByAgency(){
        $m = new M();
        return $m->generateSettleByAgency();
    }
}
