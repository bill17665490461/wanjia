...
class Orders extends Base{
    ...
    */
	...
	public function waitReceive(){
		if($this->isMobile()){
			$m = new M();
			$rs = $m->userOrdersByPage([1,0]);
			$this->assign('data',$rs);
			$pages = $m->ordersPages([1,0]);
			$this->assign('pages',$pages);
		}
