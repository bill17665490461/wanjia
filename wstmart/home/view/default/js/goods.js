...
function addCart(n,iptId){
	...
	$.post(WST.U('home/carts/addCart'),{goodsId:goodsInfo.id,type:type,goodsSpecId:goodsSpecId,buyNum:buyNum,rnd:Math.random()},function(data,textStatus){
	    var json = WST.toJson(data);
	    if(json.status==1){
